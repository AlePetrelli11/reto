...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>Reto</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Reto</b> Prueba</span>
    </a>
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#AgregarHistoria">Agregar Historia</button>

            </div>

            @include('modulos.Historias') 

        </div>

    </section>

    @include('modulos.AgregarHistoriaModal') 
    @include('modulos.DetallesModal') 
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
...
$('.table').on('click', '.EliminarHistoria', function(){
    ...
    Swal.fire({
      ...
      title: '¿Seguro qué Desea Eliminar la Hsitoria del Paciente: '+Paciente+'?',
      icon: 'warning',
      ...
      if(result.isConfirmed){
        ...
        window.location = "http://asdepicasweb.com/reto/public/Eliminar-Historia/"+Hid;
...
@if(session('HistoriaAgregada') == 'OK')

    <script type="text/javascript">
      
      Swal.fire(

          'La Historia ha Sido Agregada',
          '',
          'success'
